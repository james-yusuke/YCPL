...
grep -q 'store i32 16, ptr %function_body_real_node_lowering_limit' "$strict_ir_dir/project_body.ll"
grep -q 'store i32 32, ptr %function_body_real_expr_lowering_limit' "$strict_ir_dir/project_body.ll"
grep -q 'store i32 16, ptr %function_body_real_statement_expr_lowering_limit' "$strict_ir_dir/project_body.ll"
grep -q 'store i32 16, ptr %function_body_real_lowered_node_count' "$strict_ir_dir/project_body.ll"
grep -q 'store i32 32, ptr %function_body_real_lowered_expr_count' "$strict_ir_dir/project_body.ll"
...
grep -q 'store i32 16, ptr %function_statement_expr_owner_limit' "$strict_ir_dir/project_body.ll"
