...
function fallbackStdlib(): StandardLibrarySymbol[] {
  return [
    ...
    { label: "std2/base32", modulePath: "std2/base32", moduleAlias: "base32", detail: "YCPL standard library module", kind: CompletionItemKind.Module },
    { label: "std2/bytes", modulePath: "std2/bytes", moduleAlias: "bytes", detail: "YCPL standard library module", kind: CompletionItemKind.Module },
    ...
    { label: "bytes.from_string", modulePath: "std2/bytes", moduleAlias: "bytes", symbolName: "from_string", detail: "from_string(text string) Bytes", signature: "from_string(text string) Bytes", returnType: "Bytes", parameters: [{ name: "text", typeName: "string" }], kind: CompletionItemKind.Function },
    { label: "bytes.free", modulePath: "std2/bytes", moduleAlias: "bytes", symbolName: "free", detail: "free(b Bytes)", signature: "free(b Bytes)", parameters: [{ name: "b", typeName: "Bytes" }], kind: CompletionItemKind.Function },
    { label: "bytes.eq", modulePath: "std2/bytes", moduleAlias: "bytes", symbolName: "eq", detail: "eq(a Bytes, b Bytes) bool", signature: "eq(a Bytes, b Bytes) bool", returnType: "bool", parameters: [{ name: "a", typeName: "Bytes" }, { name: "b", typeName: "Bytes" }], kind: CompletionItemKind.Function },
    { label: "base32.encode", modulePath: "std2/base32", moduleAlias: "base32", symbolName: "encode", detail: "encode(b Bytes) string", signature: "encode(b Bytes) string", returnType: "string", parameters: [{ name: "b", typeName: "Bytes" }], kind: CompletionItemKind.Function },
    { label: "base32.decode", modulePath: "std2/base32", moduleAlias: "base32", symbolName: "decode", detail: "decode(text string) Bytes", signature: "decode(text string) Bytes", returnType: "Bytes", parameters: [{ name: "text", typeName: "string" }], kind: CompletionItemKind.Function }
  ];
}
