...
LLVM バックエンド、static link される managed runtime、YCPL で書かれた
標準ライブラリ、サンプル、LSP を含みます。
ソース拡張子は `.yc` です。
...
├─ bootstrap/cpp/runtime/ native output に static link する managed allocation runtime
